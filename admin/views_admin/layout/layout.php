<div id="viewport">
  ...
  <div id="sidebar">
    <header>
      <a href="../?action=trangchu" title="xem trang web">
        <div style="color:white;" href="#">Quản Trị Viên<br> </div> 
      	<div style="line-height: 1px; color:white;font-size: 10px;"><span style="color:orange;">XE</span> RAPTOR</div>
      </a>
    ...
    <ul class="nav">
      ...
      <li>
        <a href="?action=lienhe">
          <i class="fa fa-table"></i>Quản lý liên hệ
        </a>
      </li>
