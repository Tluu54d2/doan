 ...
 <div class="header-middle"><!--header-middle-->
        ...
        <div class="header-bottom"style="background-color:#ffd400"><!--header-bottom-->
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenuu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="?action=trangchu" class="active">
                                  <div class="btn-group">
                                        <img src="public/image/coollogo_com-68991027.png" alt="logo" title="về trang chủ">
                                 </div>
                                </a></li>
                                <li class="dropdown"><a href="?action=cuahang1" style="font-size: 20px;color:#a52a2a;font-weight: bold">Cửa Hàng</a></li> 
                                 
                                 <!-- lấy action là id loại sản phẩm -->

                                <?php foreach ($data_loaisanpham as $value) {  ?>
                                <li class="dropdown"><a href="?action=cuahang&id=<?= $value['idLoaiSP'] ?>" style="font-size: 20px;font-weight: bold"><?= $value['tenLSP'] ?></a></li>    
                              <?php }  ?>
                              <li class="dropdown"><a href="?action=lienhe1" style="font-size: 20px;color:green;font-weight: bold">Liên hệ</a></li> 
